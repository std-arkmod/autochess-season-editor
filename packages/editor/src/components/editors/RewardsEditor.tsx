...
import { CNumberInput, CSelect, CTextInput, CollabEditingProvider } from '../collab/CollabInputs'
          ...
          {baseRewardDataList.map((r, i) => (
            <Table.Tr key={i}>
              ...
              <Table.Td>
                <CNumberInput
                  size="xs"
                  collabField={`rewardMissionPoint[${i}]`}
